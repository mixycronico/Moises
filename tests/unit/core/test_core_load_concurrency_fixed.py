...
async def test_long_running_components():
    ...
    slow_comp = LoadTestComponent("slow", processing_time=0.3)  # Tiempo razonable para pruebas
    very_slow_comp = LoadTestComponent("very_slow", processing_time=0.6)  # Tiempo más largo pero razonable
